...
# walk.
#
# `Errors` is just `List[Error]`. Combinators in `combine.lex`
# accumulate by concatenation; producers in `field.lex` always
# return a singleton or empty list. The module has no effects.
