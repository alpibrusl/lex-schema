...
fn str_hint(checks :: List[c.StrCheck]) -> Str {
  let parts := list.reverse(list.fold(checks, [], fn (acc :: List[Str], chk :: c.StrCheck) -> List[Str] {
...
fn int_hint(checks :: List[c.IntCheck]) -> Str {
  let parts := list.reverse(list.fold(checks, [], fn (acc :: List[Str], chk :: c.IntCheck) -> List[Str] {
...
fn float_hint(checks :: List[c.FloatCheck]) -> Str {
  let parts := list.reverse(list.fold(checks, [], fn (acc :: List[Str], chk :: c.FloatCheck) -> List[Str] {
...
fn py_field_args(field :: s.Field) -> Str {
  ...
  let parts := list.reverse(list.fold([kind_args, desc_arg], [], fn (acc :: List[Str], part :: Str) -> List[Str] {
...
fn py_list_args(checks :: List[c.ListCheck]) -> Str {
  let parts := list.reverse(list.fold(checks, [], fn (acc :: List[Str], chk :: c.ListCheck) -> List[Str] {
...
fn zod_str(checks :: List[c.StrCheck]) -> Str {
  let chain := list.fold(checks, "z.string()", fn (acc :: Str, chk :: c.StrCheck) -> Str {
...
fn str_checks_sql(col :: Str, checks :: List[c.StrCheck], dialect :: SqlDialect) -> List[Str] {
  list.reverse(list.fold(checks, [], fn (acc :: List[Str], chk :: c.StrCheck) -> List[Str] {
...
fn int_checks_sql(col :: Str, checks :: List[c.IntCheck]) -> List[Str] {
  list.reverse(list.fold(checks, [], fn (acc :: List[Str], chk :: c.IntCheck) -> List[Str] {
...
fn float_checks_sql(col :: Str, checks :: List[c.FloatCheck]) -> List[Str] {
  list.reverse(list.fold(checks, [], fn (acc :: List[Str], chk :: c.FloatCheck) -> List[Str] {
